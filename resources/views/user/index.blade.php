...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="Approveuser(this)" id="Approveuser"
                        class="btn bg-primary-subtle text-primary  waves-effect text-start">
                        อนุมัติ
                    </button>
                    <button type="button" onclick="Nopproveuser(this)" id="Nopproveuser"
    ...
    <div class="modal fade" id="reject-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="message-text" class="">ข้อความ:</label>
                            <textarea class="form-control" id="Commentreject"></textarea>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn bg-secondary-subtle text-secondary " data-bs-dismiss="modal">
                        ปิด
                    </button>
                    <button type="button" id="notapprove" onclick="confirmreject(this)" class="btn bg-danger-subtle text-danger  waves-effect text-start">
                        ไม่อนุมัติ
                    </button>
                </div>
            </div>
...
@push('scripts')
    <script>
        ...
        function Nopproveuser(el) {
            var id = $(el).attr("data-id");
            $("#reject-modal").modal("show")
            $("#notapprove").attr('data-id', id)
        }

        function confirmreject(el){
            var Commentreject = $("#Commentreject").val()
            if(Commentreject == ""){
                toastr.warning("กรุณากรอกเหตุผล");
                return false;
            }
        ...
        function detailuser(id) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#Approveuser").attr('data-id', id)
                    $("#Nopproveuser").attr('data-id', id)

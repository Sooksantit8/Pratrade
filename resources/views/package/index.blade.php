...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">แพ็คเกจ</h4>
                </div>
                <div class="col-3">
    ...
    <div class="datatables">
        <div class="action-btn layout-top-spacing mb-3 d-flex align-items-center justify-content-end flex-wrap gap-6">
            <a href="{{ route('package.create') }}" class="btn waves-effect waves-light btn-primary mb-2">
                เพิ่มแพ็คเกจ
            </a>
        </div>
            ...
            <div class="row">
                <div class="col-md-3 col-xl-3">
                    <form class="position-relative">
                        <input type="text" class="form-control product-search ps-5 mb-1 mt-1" id="input-search-package"
                            name="search_package" placeholder="ค้นหาแพ็คเกจ">
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="packageTable" class="table table-striped table-bordered text-nowrap align-middle"
                        style="width: 100%">
                        <thead>
                            <tr>
                                <th>แพ็คเกจ</th>
                                <th>จำนวนโพสสินค้า</th>
                                <th>ฟังก์ชันกลาง</th>
                                <th></th>
                            </tr>
                        </thead>
            ...
            const table = $('#packageTable').DataTable({
                ...
                ajax: {
                    ...
                    data: function (d) {
                        ...
                        d.search_package = $('#input-search-package').val();
                    },
                },
                columns: [{
                        data: 'Package_Name',
        ...
        function deletePackage(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // ส่งคำขอลบผ่าน Ajax
                    $.ajax({
                        url: '/package/destroy/' + id, // แก้ไขเป็น /categories/{id}
                        type: 'POST',
